...
cat(sprintf("\n=========== FILES SAVED TO: %s ===========\n", dir_output))
cat("  - T3_OUD_spending_effectiveness.csv (Weaver methodology: median, IQR, category stability)\n")
cat("  - T6_OUD_decomp_by_state.csv (spending decomposition with 95% UI)\n")
cat("  - T8_OUD_decomp_daly.csv (DALY decomposition with 95% UI)\n")
